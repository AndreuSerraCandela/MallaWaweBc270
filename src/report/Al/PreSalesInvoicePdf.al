/// <summary>
/// Report Sales-Invoice Pdf (ID 50023).
/// </summary>
report 50027 "Pre-Sales-Invoice Pdf"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/layout/PreSalesInvoicePdf.rdlc';
...
#pragma warning restore AL0432
#else
                    //   numreg := 'Nº de registro: ' + "Sales Invoice Header"."bill-to No.";
#endif
                    // TODO: - CLEAN22
                END;
                CASE wTotal2 OF
    ...
    begin
        ...
        if "Sales Invoice Header"."Nº Contrato" = '' THEN
    ...
    begin
        ...
        SalesInvoiceHeader.SETRANGE("Order No.", "Sales Invoice Header"."Nº Contrato");
        ...
        SalesShipmentLine.SETRANGE("Order No.", "Sales Invoice Header"."Nº Contrato");
    ...
    begin
        ...
        OrderNoText := FormatDocument.SetText(SalesInvoiceHeader."Nº Contrato" <> '', SalesInvoiceHeader.FIELDCAPTION("Nº Contrato"));
