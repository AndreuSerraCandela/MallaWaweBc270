// /// <summary>
// /// Report Sales-Credit Memo Malla (ID 50029).
// /// </summary>
// report 50029 "Sales-Credit Memo Malla"
// {
//     DefaultLayout = RDLC;
//     RDLCLayout = './src/report/layout/SalesCreditMemo.rdlc';
...
//             RequestFilterHeading = 'Abono de venta';
...
//                 if "Nº Contrato" = '' Then begin
//                     if rJob.Get("Nº Proyecto") Then begin
//                         rContr.Reset();
//                         rContr.SetRange("Nº Proyecto", "Sales Invoice Header"."Nº Proyecto");
//                         if rContr.FindFirst() Then "Nº Contrato" := rContr."No.";
//                     end;

//                 end;
//                 "Return Order No." := "Nº Contrato";
//                 if "Return Order No." = '' THEN
//                     OrderNoText := ''
//                 ELSE
//                     OrderNoText := 'Contrato';
...
//         SalesInvoiceHeader.SETRANGE("Order No.", "Sales Invoice Header"."Return Order No.");
...
//         OrderNoText := 'CONTRATO';//FormatDocument.SetText(SalesInvoiceHeader."Order No." <> '', SalesInvoiceHeader.FIELDCAPTION("Order No."));
