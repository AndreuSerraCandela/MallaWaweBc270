/// <summary>
/// Report CheckKuara (ID 50018).
/// </summary>
report 50015 CheckKuara
{
    DefaultLayout = RDLC;
    ...
    var
        ...
        Text043: Label 'DOCE';
        Text044: Label 'TRECE';
        Text045: Label 'CATORCE';
        Text046: Label 'QUINCE';
        Text047: Label 'DIECISEIS';
        Text048: Label 'DIECISIETE';
        Text049: Label 'DIECIOCHO';
        Text050: Label 'DIECINUEVE';
        Text051: Label 'VEINTE';
        Text052: Label 'TREINTA';
        Text053: Label 'CUARENTA';
        Text054: Label 'CINCUENTA';
        Text055: Label 'SESENTA';
        Text056: Label 'SETENTA';
        Text057: Label 'OCHENTA';
        Text058: Label 'NOCENTA';
        Text059: Label 'CIEN';
        Text060: Label 'MILLON';
        Text061: Label 'BILLON';
        ...
        Text1100757: Label 'MILESIMAS';
        Text1100758: Label 'DIEZMILESIMAS';
        Text1100759: Label ' CENTIMOS';
        Text1100760: Label ' CENTIMOS';
        Text1100761: Label 'MILSEIMA';
        Text1100762: Label 'DIEZMILESIMA';
    ...
    /// InitializeRequest.
    /// </summary>
    /// <param name="BankAcc">Code[20].</param>
    /// <param name="LastCheckNo">Code[20].</param>
    /// <param name="NewOneCheckPrVend">Boolean.</param>
    /// <param name="NewReprintChecks">Boolean.</param>
    /// <param name="NewTestPrint">Boolean.</param>
    /// <param name="NewPreprintedStub">Boolean.</param>
