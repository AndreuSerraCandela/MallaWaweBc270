/// <summary>
/// Report Receivable Bill Ces (ID 50019).
/// </summary>
report 50013 "Receivable Bill Ces"
{
    // 001 21/09/15 - Impedimos guardar numero pagare si es vista preliminar.
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/layout/ReceivableBill.rdlc';
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    Caption = 'Pagaré Garden';
...
#pragma warning restore AL0432
                ...
                if Customer."Pay-to Vendor No." <> '' then
                    if CustPmtAddress.Get(Customer."Pay-to Vendor No.") THEN
    ...
    /// <param name="VendPmtAddress">VAR Record "Vendor".</param>
