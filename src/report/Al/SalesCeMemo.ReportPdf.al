// /// <summary>
// /// Report Sales-CrMemo Pdf (ID 50030).
// /// </summary>
// report 50030 "Sales-CrMemo Pdf"
// {
//     DefaultLayout = RDLC;
//     RDLCLayout = './src/report/layout/SalescrMemoPdf.rdlc';
//     Caption = 'Abono Venta';
...
//             RequestFilterHeading = 'Abonos de venta';
...
//                     {
//                     }
//                     column(OrderNo_SalesInvHeader; "Sales Invoice Header"."Nº Contrato")
//                     {
//                     }
...
//                     { }
//                     column(Fecha_Inicial_Contrato; 0D)
//                     {

//                     }
//                     Column(Fecha_final_proyecto; "Sales Invoice Header"."Corrected Invoice No.")
//                     { }
...
//                           WHERE("Document Type" = CONST("Detalle Abo. Reg"),
//                                 Validada = CONST(true));
//                         DataItemLinkReference = "Sales Invoice Header";
...
//                         CODEUNIT.RUN(CODEUNIT::"Sales Cr. Memo-Printed", "Sales Invoice Header");
//                 end;
...
//                 if rLinV.FIND('-') THEN
//                     HayDto := '%Dto';
//                 rCom.SETRANGE(rCom."Document Type", rCom."Document Type"::"Detalle Abo. Reg");
...
//                     OrderNoText := ''
//                 ELSE
//                     OrderNoText := FIELDCAPTION("Nº Contrato");
...
//                               "Campaign No.", "Posting Description", '');
//                     END;
//                 if (SalesSetup."Logo Position on Documents" = SalesSetup."Logo Position on Documents"::Center)
//                 //And (Logotipo) 
//                 Then begin
//                     CompanyInfo1.Get();
...
//         TextoLopd: Text;
//         TextoPie: Text;
//         Text004: Label 'Abono nº %1', Comment = '%1 = Document No.';
...
//         InvoiceNoCaptionLbl: Label 'Nº Abono';
...
//         //if "Sales Invoice Header"."C" = '' THEN
...
//     local procedure GenerateBufferFromValueEntry(SalesInvoiceLine2: Record 115)
//     var
...
//     local procedure GenerateBufferFromShipment(SalesInvoiceLine: Record 115)
//     var
//         SalesInvoiceHeader: Record 114;
//         SalesInvoiceLine2: Record 115;
//         SalesShipmentHeader: Record 110;
...
//         SalesInvoiceHeader.SETRANGE("Return Order No.", "Sales Invoice Header"."Return Order No.");
...
//         SalesShipmentLine.SETRANGE("Order No.", "Sales Invoice Header"."Return Order No.");
...
//     local procedure AddBufferEntry(SalesInvoiceLine: Record 115; QtyOnShipment: Decimal; PostingDate: Date)
//     begin
...
//     /// </summary>
//     /// <param name="SalesInvoiceHeader">Record 114.</param>
//     /// <returns>Return value of type Text.</returns>
//     procedure ShowCashAccountingCriteria(SalesInvoiceHeader: Record 114): Text
//     var
//         VATEntry: Record 254;
//     begin
//         GLSetup.GET;
...
//     local procedure FormatDocumentFields(SalesInvoiceHeader: Record 114)
//     begin
...
//     local procedure FormatAddressFields(SalesInvoiceHeader: Record 114)
//     begin
...
//     PROCEDURE FiltroTexto2(r113: Record 115; VAR rTexto: Record "Texto Presupuesto");
//     BEGIN
