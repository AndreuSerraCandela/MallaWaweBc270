...
// /// </summary>
// report 50023 "Sales-Invoice Pdf"
// {
//     DefaultLayout = RDLC;
//     RDLCLayout = './src/report/layout/SalesInvoicePdf.rdlc';
//     Caption = 'Factura Venta';
//     EnableHyperlinks = true;
//     Permissions = TableData 7190 = rimd, tabledata 113 = RIMD;
...
//                 rLinV.SetFilter(Amount, '<>%1', 0);
//                 rLinV.ModifyAll(Imprimir, TRUE);
//                 rLinV.SetRange(Amount);
