/// <summary>
/// Codeunit Reverse (ID 7001108).
/// </summary>
Codeunit 7001108 Reverse
{
    ...
    var
        ...
        GenJnlPostReverse: Codeunit "Gen. Jnl. Reverse";
        Txt: Text[1024];
    ...
    var
        Text002: Label 'Quier revertir los movimientos?';
        Text003: Label 'Los movimientos se revertirán.';
    ...
    /// SetPrint.
    /// </summary>
    /// <param name="NewPrintRegister">Boolean.</param>
...
Codeunit 7001109 "Gen. Jnl. Reverse"
{
    ...
    /// Reverse.
    /// </summary>
    /// <param name="ReversalEntry">VAR Record "Reversal Entry".</param>
    /// <param name="ReversalEntry2">VAR Record "Reversal Entry".</param>
    ...
    begin
        ...
        // ReversalEntry2."Posting Date":=FechaAlbaran(ReversalEntry2."Posting Date");
        GenJnlLine.Init();
        GenJnlLine."Source Code" := SourceCodeSetup.Reversal;
        GenJnlLine."Posting Date" := ReversalEntry2."Posting Date";
        if C11.DateNotAllowed(GenJnlLine."Posting Date") THEN ERROR('La fecha esta en un periodo cerrado');
    ...
    //     if DATE2DMY(POSTINGDATE, 2) < DATE2DMY(WORKDATE, 2) THEN EXIT(WORKDATE);
    //     EXIT(POSTINGDATE);
    // END;
        ...
        with GLEntry2 do
            if Find('+') then
                repeat
                    ...
                    case true of
                        TempCustLedgEntry.Get("Entry No."):
                            begin
                                ...
                                ReverseCustLedgEntry(
                                  ...
                                  NextDtldCustLedgEntryEntryNo, GLEntry."Posting Date");
                        ...
                        TempVendLedgEntry.Get("Entry No."):
                            begin
                                ...
                                ReverseVendLedgEntry(
                                  ...
                                  NextDtldVendLedgEntryEntryNo, GLEntry."Posting Date");
                        ...
                        TempEmployeeLedgerEntry.Get("Entry No."):
                            begin
                                ...
                                ReverseEmplLedgEntry(
                                  ...
                                  NextDtldEmplLedgEntryNo, GLEntry."Posting Date");
                        ...
                        TempBankAccLedgEntry.Get("Entry No."):
                            begin
                                ...
                                ReverseBankAccLedgEntry(TempBankAccLedgEntry, GLEntry."Entry No.", GenJnlLine."Source Code", GLEntry."Posting Date");
                    ...
                    ReverseVAT(GLEntry, GenJnlLine."Source Code", GLEntry."Posting Date");
                until Next(-1) = 0;

        // OnAfterReverseGLEntry(GLEntry);
    end;

    local procedure ReverseCustLedgEntry(CustLedgEntry: Record "Cust. Ledger Entry"; NewEntryNo: Integer; Correction: Boolean; SourceCode: Code[10]; var NextDtldCustLedgEntryEntryNo: Integer; PostingDate: Date)
    var
    ...
    begin
        with NewCustLedgEntry do begin
            ...
            repeat
                ...
                NewCustLedgEntry."Posting Date" := PostingDate;
    ...
    local procedure ReverseVendLedgEntry(VendLedgEntry: Record "Vendor Ledger Entry"; NewEntryNo: Integer; Correction: Boolean; SourceCode: Code[10]; var NextDtldVendLedgEntryEntryNo: Integer; PostingDate: Date)
    var
    ...
    local procedure ReverseEmplLedgEntry(EmployeeLedgerEntry: Record "Employee Ledger Entry"; NewEntryNo: Integer; Correction: Boolean; SourceCode: Code[10]; var NextDtldEmplLedgEntryNo: Integer; PostingDate: Date)
    var
    ...
    local procedure ReverseBankAccLedgEntry(BankAccLedgEntry: Record "Bank Account Ledger Entry"; NewEntryNo: Integer; SourceCode: Code[10]; PostingDate: Date)
    var
    ...
    local procedure ReverseVAT(GLEntry: Record "G/L Entry"; SourceCode: Code[10]; PostingDate: Date)
    var
        VATEntry: Record "VAT Entry";
