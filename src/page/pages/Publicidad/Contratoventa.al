        ...
        area(processing)
        {
            group(Acciones)
            {
                ...
                action("Generar PDF por lotes")
                {
                    ...
                    var
                    begin
                        Report.RunModal(Report::Contrato);
                    end;
                }
            ...
            group("P&osting")
            {
                ...
                action("Proponer facturación contratos")
                {
                    ...
                    //         if (Estado <> Estado::Firmado) AND
                    //         (Estado <> Estado::"Sin Montar") THEN
                    //             ERROR(Text004);
                    //     END;
                    //     // $003
                    //     rLineas.RESET;
                    //     CLEAR(rLineas);
                    //     rLineas.SETRANGE("Document Type", "Document Type");
                    //     rLineas.SETRANGE("Document No.", "No.");
                    //     rLineas.SETFILTER("Prepmt. Line Amount", '<>%1', 0);
                    //     rLineas.SETFILTER("Prepmt. Amt. Inv.", '%1', 0);
                    //     if NOT rLineas.ISEMPTY THEN
                    //         //ERROR(Text003);                 //$012
                    //         ERROR(Text005);                   //$012
        ...
        area(Reporting)
        {
            action("Imprimir Letras")
            {
                ...
                begin
                    ...
                    Report.RunModal(Report::Letras, true, true, Contrato);
                end;
            }
