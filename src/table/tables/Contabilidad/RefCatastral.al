...
/// </summary>
table 7001110 "Ref Catastral Address"
{

    DataCaptionFields = "Vendor No.", Name, "Code";
    Caption = 'Dirección Catastral';
    LookupPageId = "Lista Referencias Catastrales";
    DrillDownPageId = "Lista Referencias Catastrales";
    fields
    {
        ...
        field(2; "Code"; Code[30])
        {
            ...
            If (Tipo = CONST(Empresa)) "Company Information"."Primary Key" WHERE("Primary Key" = FIELD("Vendor No."));
            trigger OnValidate()
            VAR
