/// <summary>
/// TableExtension Purch. Inv. HeaderKuara (ID 80175) extends Record Purch. Inv. Header.
/// </summary>
tableextension 80175 "Purch. Inv. HeaderKuara" extends "Purch. Inv. Header"
{
    fields
    {
        field(50004; "Emplazamiento"; TEXT[30])
        {
            TableRelation = "Emplazamientos proveedores"."Nº Emplazamiento" where("Nº Proveedor" = field("Buy-from Vendor No."));
        ...
        //     CalcFormula = Sum("Purch. Inv. Line"."Retention Amount (GE)" WHERE("Document No." = FIELD("No.")));
        ...
        //     ObsoleteState = Removed;
        //     FieldClass = FlowField;
        //     CalcFormula = Sum("Purch. Inv. Line"."Retention Amount (IRPF)" WHERE("Document No." = FIELD("No.")));
